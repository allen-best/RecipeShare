(function($) {
    ...
    function setListItem(post) {
        ...
        let newItem = $(`<li>${name} &emsp; type: ${type} &emsp; ${likes} likes &emsp; ${time} &emsp; <a href='/post/${id}'>View</a> <a href='/post/edit/${id}'>Edit</a>   </li>`);
        return newItem;
    }
        ...
        if ($('#search_term').val().trim()) {
            ...
            $.ajax(searchRequest).then(function(responseMessage) {
                ...
                if (!searchPost || searchPost.length === 0) {
                    ...
                    ${servings}servings &emsp; time needed: ${timeNeeded} &emsp; ${time} &emsp; <a href='/post/${id}'>View</a> <a href='/post/edit/${id}'>Edit</a> </li>`);
